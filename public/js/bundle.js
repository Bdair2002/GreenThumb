...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(username, firstname, lastname, email, password, passwordconfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          console.log(username, firstname, lastname, email, password, passwordconfirm);
          _context2.next = 4;
          return (0, _axios.default)({
            method: 'POST',
        ...
        case 8:
          ...
          console.log('Something went wrong!');
          (0, _alerts.showAlert)('error', 'Error signing! Try again.');
        case 12:
        case "end":
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _login.signup)(userName, firstName, lastName, email, password, passwordConfirm);
});
